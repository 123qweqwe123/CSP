 ...
 * </pre>
 * 
 * Author: huangrupeng Create: 17/5/17 下午1:23
 */
@RestController
@RequestMapping("/sys")
public class SysController {
    ...
    public void createAccount(SysAccountVO account, String[] roleIds) {
        sysService.createAccountPerson(account, roleIds);
    }
    ...
    public void updateAccount(SysAccountVO account, String[] roleIds) {
        sysService.updateAccountPerson(account, roleIds);
    }
