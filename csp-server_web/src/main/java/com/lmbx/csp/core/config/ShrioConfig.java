...
import com.lmbx.csp.core.shiro.filter.MyFormAuthenticationFilter;
import com.lmbx.csp.core.shiro.filter.MyLogoutFilter;
import com.lmbx.csp.core.shiro.filter.MyUserFilter;
import com.lmbx.csp.core.shiro.realm.ShiroDbRealm;
...
//        sessionManager.setGlobalSessionTimeout(1800000); // session 失效时间
...
//    }
    ...
    /**
     * 实现了Initializable或者Destroyable的shiro对象将会自动调用init() and/or destory()方法 所以这个Bean需要使用 @DependsOn 在其它对象之前初始化
     *
     * @return
     */
    @Bean
