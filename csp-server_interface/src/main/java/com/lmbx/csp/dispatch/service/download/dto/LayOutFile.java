...
public class LayOutFile {
    ...
    public LayOutFile(String id, Short fileType, String templateFileId, List<ParamData> dataMap, String fileData){
        this.id = id;
    ...
    public String toString() {
        return "LayOutFile{" + "id='" + id + '\'' + ", fileType=" + fileType + ", templateFileId='" + templateFileId
