...
public class SetVersionInterceptorUtils {


public Map<String,String> getData( String querySql,DataSource dataSource){
    ...
    public String formatSql(String sql, Object parameterObject, List<ParameterMapping> parameterMappingList) {
        // 输入判断是否为空
        if (sql == "" || sql.length() == 0) {
            return "";
        }
    ...
    private String handleCommonParameter(String sql, List<ParameterMapping> parameterMappingList,
        ...
        for (ParameterMapping parameterMapping : parameterMappingList) {
            ...
            if (isPrimitiveOrPrimitiveWrapper(parameterObjectClass)) {
                if(parameterObjectClass.isAssignableFrom(String.class)){
